...
export const prompt = ({ type, description, context }: { type: string, description: string, context: string }) => {
  return `You professional copywriting/researcher who specializes in extracting specific types of information from given texts, providing comprehensive and structured outputs to enhance understanding of the original content.
