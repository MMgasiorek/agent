...
From now on, analyze the ongoing conversation and generate a JSON object with a thinking process and action plan.
This is part of an internal thinking process that focuses on making a plan. The user CANNOT see these responses due to the system design.
